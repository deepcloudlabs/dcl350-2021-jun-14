 ...
 *
 */
@Service // Spring Bean -> component
@Scope("singleton") // singleton -> default, request, session, prototype
// @RequestScope -> @Scope("request") -> Spring Web (Spring MVC)
// @SessionScope -> @Scope("session") -> Spring Web (Spring MVC)
